...
class BaseTest extends Specification {
    final HOMER_ID = IntId.one("homer").longValue()
    final BART_ID = IntId.one("bart").longValue()
    ...
    final COMMENT_ID = IntId.one("comment1").longValue()
    final NOT_EXISTING_COMMENT_ID = 9999
    final ARCHIVED_COMMENT_ID = IntId.one("archived_comment").longValue()
}
